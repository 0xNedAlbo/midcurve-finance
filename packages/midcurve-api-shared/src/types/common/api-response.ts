...
export enum ApiErrorCode {
  ...
  STRATEGY_INVALID_STATE = 'STRATEGY_INVALID_STATE',
  STRATEGY_NOT_DEPLOYED = 'STRATEGY_NOT_DEPLOYED',
  STRATEGY_QUOTE_TOKEN_MISMATCH = 'STRATEGY_QUOTE_TOKEN_MISMATCH',
}
...
export const ErrorCodeToHttpStatus: Record<ApiErrorCode, number> = {
  ...
  [ApiErrorCode.STRATEGY_ALREADY_EXISTS]: 409,
  [ApiErrorCode.STRATEGY_INVALID_STATE]: 422,
  [ApiErrorCode.STRATEGY_NOT_DEPLOYED]: 422,
  [ApiErrorCode.STRATEGY_QUOTE_TOKEN_MISMATCH]: 422,
};
