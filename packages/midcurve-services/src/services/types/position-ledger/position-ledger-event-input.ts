...
/**
 * Base interface for creating any position ledger event
 */
interface BaseCreatePositionLedgerEventInput {
  ...
  pnlAfter: bigint;
  /**
   * Hash generated from event coordinates to ensure idempotency
   * Generated by the service using protocol-specific logic
   */
  inputHash?: string;
}
...
/**
 * Input for creating a Uniswap V3 position ledger event
 */
export interface CreateUniswapV3LedgerEventInput
  extends BaseCreatePositionLedgerEventInput {
  protocol: 'uniswapv3';
...
/**
 * Union type for any ledger event create input
 */
export type CreateAnyLedgerEventInput = CreateUniswapV3LedgerEventInput;
...
/**
 * Union type for all discovery inputs
 */
export type PositionLedgerEventDiscoverInput = UniswapV3LedgerEventDiscoverInput;

/**
 * Type aliases for discovery inputs
 */
export type UniswapV3EventDiscoverInput = UniswapV3LedgerEventDiscoverInput;
export type AnyLedgerEventDiscoverInput = UniswapV3LedgerEventDiscoverInput;
