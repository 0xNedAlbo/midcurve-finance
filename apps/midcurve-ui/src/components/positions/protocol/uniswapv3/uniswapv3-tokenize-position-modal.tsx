...
export function UniswapV3TokenizePositionModal({
  ...
  const approvalPrompt = useEvmTransactionPrompt({
    ...
    showActionButton: !nftApproval.isChecking && !nftApproval.isApproved && !nftApproval.isApproving && !nftApproval.isWaitingForConfirmation,
    txHash: nftApproval.txHash,
    isSubmitting: nftApproval.isApproving,
    isWaitingForConfirmation: nftApproval.isChecking || nftApproval.isWaitingForConfirmation,
