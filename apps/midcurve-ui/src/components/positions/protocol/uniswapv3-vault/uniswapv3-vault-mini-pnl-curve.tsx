/**
 * UniswapV3VaultMiniPnLCurve - Protocol-specific mini PnL curve for vault positions
 *
 * Renders a compact SVG visualization of the vault position's PnL curve showing:
...
export function UniswapV3VaultMiniPnLCurve({
  position,
  width = 120,
  height = 60,
  overrideTick,
}: UniswapV3VaultMiniPnLCurveProps) {
  // Tooltip state
  ...
  const simulationPosition = useMemo(() => {
    ...
    if (userLiquidity <= 0n) return null;
