/**
 * UniswapV3VaultSwitchQuoteTokenModal - Confirmation modal for switching quote/base tokens
 *
...
interface UniswapV3VaultSwitchQuoteTokenModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function UniswapV3VaultSwitchQuoteTokenModal({
  isOpen,
  onClose,
  onSwitchSuccess,
  positionHash,
  ...
  feeBps,
  isToken0Quote,
}: UniswapV3VaultSwitchQuoteTokenModalProps) {
