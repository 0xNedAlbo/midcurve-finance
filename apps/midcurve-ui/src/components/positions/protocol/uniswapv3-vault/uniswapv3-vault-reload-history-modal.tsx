/**
 * UniswapV3VaultReloadHistoryModal - Confirmation modal for reloading a vault position's history
 *
...
interface UniswapV3VaultReloadHistoryModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function UniswapV3VaultReloadHistoryModal({
  isOpen,
  onClose,
  onReloadSuccess,
  positionHash,
  ...
  token1Symbol,
  feeBps,
}: UniswapV3VaultReloadHistoryModalProps) {
          ...
          <div className="p-6 space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-slate-300 text-sm leading-relaxed">
                This will completely rebuild the vault position&apos;s event history
                from the blockchain.
              </p>
