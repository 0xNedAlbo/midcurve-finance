/**
 * UniswapV3VaultDeletePositionModal - Confirmation modal for deleting a vault position
 *
...
interface UniswapV3VaultDeletePositionModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export function UniswapV3VaultDeletePositionModal({
  isOpen,
  onClose,
  onDeleteSuccess,
  positionHash,
  ...
  token1Symbol,
  feeBps,
}: UniswapV3VaultDeletePositionModalProps) {
        ...
        <div className="bg-slate-800/90 backdrop-blur-md border border-slate-700/50 rounded-xl shadow-xl shadow-black/20 w-full max-w-md">
          ...
          <div className="p-6 space-y-4">
            <p className="text-slate-300 text-sm leading-relaxed">
              Are you sure you want to delete this vault position? This action cannot
            ...
            <div className="bg-slate-700/30 rounded-lg p-4 space-y-2">
              <InfoRow label="Vault" value={truncatedAddress} />
              <InfoRow
                label="Chain"
