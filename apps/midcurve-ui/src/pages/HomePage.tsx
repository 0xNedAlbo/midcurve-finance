        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
              Plan, visualize, and manage your liquidity positions with advanced
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700/50 p-6">
              ...
              <p className="text-slate-400">
                Understand your position&apos;s risk profile with our three-phase
                PnL visualization.
              </p>
            </div>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700/50 p-6">
              ...
              <p className="text-slate-400">
                Visualize profit and loss scenarios with dynamic, interactive
                curve displays.
              </p>
            </div>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700/50 p-6">
              ...
              <p className="text-slate-400">
                Import and manage positions across Ethereum, Arbitrum, and Base
                networks.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-xl border border-blue-500/20 p-8 text-center">
            ...
            <p className="text-slate-300 mb-6">
              Join Midcurve and take control of your Uniswap V3 liquidity
              positions.
            </p>
            <Link
              to="/?modal=signup"
