...
// Diamond core (shared with position-closer)
...
// Shared facets (from position-closer)
...
import {RegistrationFacet} from "../contracts/vault-position-closer/facets/RegistrationFacet.sol";
import {ExecutionFacet} from "../contracts/vault-position-closer/facets/ExecutionFacet.sol";
import {OwnerUpdateFacet} from "../contracts/vault-position-closer/facets/OwnerUpdateFacet.sol";
import {ViewFacet} from "../contracts/vault-position-closer/facets/ViewFacet.sol";

// Init
import {DiamondInit} from "../contracts/vault-position-closer/init/DiamondInit.sol";

/// @title DeployVaultPositionCloserDiamond
/// @notice Deploys the UniswapV3VaultPositionCloser as an EIP-2535 Diamond
/// @dev Reuses Diamond infrastructure and generic facets from position-closer.
///      Business logic facets are vault-specific.
contract DeployVaultPositionCloserDiamond is Script {
    // ========================================
    // CONSTANTS
    // ========================================
    ...
    /// @notice Deploy the VaultPositionCloser Diamond
    ...
    function run(address swapRouter, address owner) public returns (address diamond) {
        console.log("=== Deploying VaultPositionCloser Diamond ===");
        ...
        // 4. Build init calldata (no positionManager param)
        ...
        console.log("VaultPositionCloser Diamond:", diamond);
        console.log("Interface Version:", INTERFACE_VERSION);
    ...
    function getOwnerUpdateSelectors() internal pure returns (bytes4[] memory) {
        ...
        selectors[6] = OwnerUpdateFacet.setShares.selector;
        return selectors;
    }
    ...
    function getViewSelectors() internal pure returns (bytes4[] memory) {
        ...
        selectors[4] = ViewFacet.swapRouter.selector;
        selectors[5] = ViewFacet.maxFeeBps.selector;
        return selectors;
    }
