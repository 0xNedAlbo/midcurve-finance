...
///
///      IMPORTANT: This is a vault-position-closer-specific copy. It must import
///      Modifiers from the vault-position-closer's AppStorage to ensure the
///      whenInitialized modifier reads the correct storage slot.
