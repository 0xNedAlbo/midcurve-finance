...
import "./interfaces/IHedgeVaultDeprecated.sol";
 ...
 */
contract HedgeVault is IHedgeVaultDeprecated, ERC4626Base, ReentrancyGuard, AllowlistBase, Multicall, ParaswapHelper, TwapOracleBase {
    // ============ Immutables ============
    ...
    ) ERC4626Base(quoteToken_, name_, symbol_) ParaswapHelper(augustusRegistry_) {
    ...
    /// @inheritdoc IHedgeVaultDeprecated
    ...
    function totalAssets() public view override(ERC4626Base, IHedgeVaultDeprecated) returns (uint256) {
    ...
    function reopenFromQuote(
        ...
        uint256 leftoverQuote = IERC20(asset).balanceOf(address(this));
    ...
    function reopenFromBase(
        ...
        uint256 leftoverBase = IERC20(baseToken).balanceOf(address(this));
    ...
    function _allocateToPosition(
        ...
        if (swapData.length > 0 && maxQuoteInIdeal > 0) {
            ...
            uint256 quoteAfter = IERC20(asset).balanceOf(address(this));
    ...
    // ============ Internal - Swap Hooks (ParaswapHelper) ============
    ...
    function _swapViaPool(
        ...
        amountReceived = IERC20(buyToken).balanceOf(address(this)) - buyBalanceBefore;
    }
